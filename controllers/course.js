          ...
          course.course
            ...
            .then((courseresult) => {
              ...
              user.instructor.update(
                {
                  Num_of_Student_enrolled: sequelize.literal(
                    "Num_of_Student_enrolled + 1"
                  ),
                },
                {
                  where: {
              ...
              course.course.update(
                {
                  num_student_enrolled: sequelize.literal(
                    "num_student_enrolled + 1"
                  ),
                },
                {
                  where: {
          ...
          cart.crt
            ...
            .then((updatedresult) => {
              cart.course_cart
                ...
                .catch((err) =>
                  console.log("error in delete course_cart", err)
                );
            })
            .catch((err) => {
              ...
              cart.wishlist
                ...
                .then((updatedWishlist) => {
                  cart.course_wishlist
                    ...
                    .catch((err) => {
                      console.log(
                        "error in making new association record ",
                        err
                      );
                    });
                })
...
exports.deletewishlist = async (req, res) => {
  ...
  const wishlist = await cart.wishlist.findOne({
    where: {
      customerId: customer.id,
    },
  });
